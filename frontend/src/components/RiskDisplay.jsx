  ...
  return (
    <div className="card">
            ...
            {has_disease ? (
              <>
                ...
                <span className="text-sm text-gray-600">
                  Angiographic risk indicators suggest ≥50% vessel narrowing - intervention
                  recommended
                </span>
              </>
            ) : (
              <>
                ...
                <br />
                <span className="text-sm text-gray-600">
                  Clinical indicators show &lt;50% vessel narrowing - continue monitoring and
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
        <div className="mb-3">
          <h4 className="text-sm font-bold text-gray-800 mb-2">What does this risk score mean?</h4>
          <p className="text-sm text-gray-700 mb-2">
            This score represents the probability of <strong>Coronary Artery Disease (CAD)</strong>{' '}
            - significant narrowing (≥50% blockage) in the arteries that supply blood to your heart
            muscle.
          </p>
        </div>
          ...
          <div className="space-y-2">
            <div>
              ...
              <ul className="text-xs text-gray-700 ml-4 space-y-0.5">
                ...
                <li>
                  • <strong>Angina Symptoms:</strong> Frequent chest pain limiting work, travel, and
                  recreation
                </li>
                <li>
                  • <strong>Psychological Impact:</strong> Anxiety about heart events, depression
                  from activity restrictions
                </li>
                <li>
                  • <strong>Treatment Burden:</strong> Daily medications, frequent doctor visits,
                  potential procedures (stents, bypass)
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-xs text-gray-700 ml-4 space-y-0.5">
                ...
                <li>
                  • <strong>With Treatment:</strong> Modern interventions can restore near-normal
                  life expectancy if started early
                </li>
                <li>
                  • <strong>Post-Heart Attack:</strong> 5-year survival rate is ~75%, with higher
        ...
        <div className="mb-3">
          <h4 className="text-sm font-bold text-gray-800 mb-2">What conditions could develop?</h4>
          <p className="text-sm text-gray-700 mb-2">
          ...
          <ul className="text-sm text-gray-700 ml-4 space-y-1">
            ...
            <li>
              • <strong>Heart Attack (Myocardial Infarction)</strong> - if a coronary artery becomes
              completely blocked
            </li>
            <li>
        ...
        <div>
          ...
          <p className="text-sm text-gray-700">
            ...
            prediction. Higher importance means that factor has more influence on your individual
            risk assessment.
          </p>
        </div>
      </div>
